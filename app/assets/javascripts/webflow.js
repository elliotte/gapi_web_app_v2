...
{"./webflow-brand":2,"./webflow-dropdown":3,"./webflow-forms":4,"./webflow-gplus":5,"./webflow-ix":6,"./webflow-lib":7,"./webflow-lightbox":8,"./webflow-links":9,"./webflow-maps":10,"./webflow-navbar":11,"./webflow-scroll":12,"./webflow-slider":13,"./webflow-tabs":14,"./webflow-touch":15}],
...
Webflow.require('ix').init([
  {"slug":"project-hover","name":"Project hover","value":{"style":{},"triggers":[{"type":"hover","selector":".project-hover","descend":true,"stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}]},{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
  ...
  {"slug":"close-contact","name":"close contact","value":{"style":{},"triggers":[{"type":"click","selector":".contact","stepsA":[{"height":"0px","transition":"height 500ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}},
  ...
  {"slug":"show-on-load","name":"Show on load","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"display-contact","name":"display contact","value":{"style":{},"triggers":[{"type":"load","selector":".contact","stepsA":[{"display":"block"}],"stepsB":[]}]}},
  {"slug":"loader","name":"loader","value":{"style":{"display":"block","opacity":1},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}}
]);
